          ...
          <div className="lg:col-span-9 space-y-4">
            ...
            <div>
                ...
                {activeTab === 'overview' && (() => {
                  ...
                  const RISK_TONE = (rating: string) => {
                    if (['AAA', 'AA', 'A', 'BBB'].includes(rating)) return 'text-emerald-600'
                    if (rating === 'BB') return 'text-amber-600'
                    return 'text-red-600'
                  }
                  const catItems = [
                          ...
                          <div className="card-body">
                            <div className="flex flex-wrap gap-2 my-3">
                              {RATING_SCALE.map(rt => (
                                <div
                                  key={rt}
                                  className={clsx(
                                    'h-8 min-w-[44px] px-2 rounded-lg border text-[13px] font-bold leading-none inline-flex items-center justify-center',
                                    activeRating === rt || cr === rt
                                      ? 'bg-[#EDF4F8] border-[#BFD7E6] text-[#0B3C5D]'
                                      : 'bg-[#F8FAFC] border-[#E5E9F0] text-slate-500'
                                  )}
                                  data-rating={rt}
                                >
                            ...
                            <div className="rating-info">
                              <div className="rating-detail">
                                ...
                                <span className={clsx('rating-detail-value', RISK_TONE(activeRating))}>
