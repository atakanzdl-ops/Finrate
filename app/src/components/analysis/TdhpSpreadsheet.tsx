...
const TDHP_ROWS: RowDef[] = [
  ...
  { type: 'account', code: '13', label: '13. Diğer Alacaklar',                                   field: 'otherReceivables' },
  { type: 'account', code: '15', label: '15. Stoklar',                                           field: 'inventory' },
  { type: 'account', code: '17', label: '17. Yıllara Yaygın İnş. ve Onarım Maliyetleri',        field: 'constructionCosts' },
  { type: 'account', code: '18', label: '18. Gelecek Aylara Ait Giderler',                       field: 'prepaidExpenses' },
  ...
  { type: 'account', code: '22', label: '22. Ticari Alacaklar',                                  field: 'longTermTradeReceivables' },
  { type: 'account', code: '23', label: '23. Diğer Alacaklar',                                   field: 'longTermOtherReceivables' },
  ...
  { type: 'account', code: '27', label: '27. Özel Tükenmeye Tabi Varlıklar',                    field: 'depletableAssets' },
  { type: 'account', code: '28', label: '28. Gelecek Yıllara Ait Giderler',                      field: 'longTermPrepaidExpenses' },
  ...
  { type: 'account', code: '33', label: '33. Diğer Borçlar',                                     field: 'otherShortTermPayables' },
  { type: 'account', code: '34', label: '34. Alınan Avanslar',                                   field: 'advancesReceived' },
  { type: 'account', code: '35', label: '35. Yıllara Yaygın İnş. Hakedişleri',                  field: 'constructionProgress' },
  { type: 'account', code: '36', label: '36. Ödenecek Vergi ve Yükümlülükler',                  field: 'taxPayables' },
  { type: 'account', code: '37', label: '37. Borç ve Gider Karşılıkları',                        field: 'shortTermProvisions' },
  { type: 'account', code: '38', label: '38. Gelecek Aylara Ait Gelirler',                       field: 'deferredRevenue' },
  ...
  { type: 'account', code: '42', label: '42. Ticari Borçlar',                                    field: 'longTermTradePayables' },
  { type: 'account', code: '43', label: '43. Diğer Borçlar',                                     field: 'longTermOtherPayables' },
  { type: 'account', code: '44', label: '44. Alınan Avanslar',                                   field: 'longTermAdvancesReceived' },
  { type: 'account', code: '47', label: '47. Borç ve Gider Karşılıkları',                        field: 'longTermProvisions' },
  ...
  { type: 'account', code: '52', label: '52. Sermaye Yedekleri',                                 field: 'capitalReserves' },
  { type: 'account', code: '54', label: '54. Kar Yedekleri',                                     field: 'profitReserves' },
  { type: 'account', code: '57', label: '57. Geçmiş Yıllar Karları',                            field: 'retainedEarnings' },
  { type: 'account', code: '58', label: '58. Geçmiş Yıllar Zararları (-)',                       field: 'retainedLosses' },
  ...
  { type: 'account', code: '60', label: '60. Brüt Satışlar',                                     field: 'grossSales' },
  { type: 'account', code: '61', label: '61. Satış İndirimleri (-)',                             field: 'salesDiscounts' },
  ...
  { type: 'account', code: '67', label: '67. Olağandışı Gelir ve Karlar',                        field: 'extraordinaryIncome' },
  { type: 'account', code: '68', label: '68. Olağandışı Gider ve Zararlar (-)',                  field: 'extraordinaryExpense' },
