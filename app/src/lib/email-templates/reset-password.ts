export function buildResetPasswordEmail(opts: { code: string; fullName?: string }) {
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:32px;">
              <p style="margin:0 0 8px;color:#1E293B;font-size:16px;font-weight:600;">Şifre Sıfırlama</p>
              ...
              <p style="margin:0 0 24px;color:#1E293B;font-size:14px;line-height:1.6;">
                Finrate hesabınız için şifre sıfırlama talebi aldık. Yeni şifrenizi belirlemek için aşağıdaki 6 haneli kodu kullanın:
              </p>
...
Finrate hesabınız için şifre sıfırlama kodunuz:
...
Finrate © 2026`
  ...
  return { html, text, subject: 'Finrate Şifre Sıfırlama Kodunuz' }
}
