      ...
      <section className="section" id="fiyatlar">
        <div className="container">
          <div style={{ textAlign: 'center' }}>
            ...
            <p className="section-sub" style={{ margin: '0 auto 8px' }}>Kayıt ücretsizdir: 14 gün boyunca tüm özellikler sınırsız (firma, dönem, senaryo, PDF rapor). Paketler analiz hakkı olarak tanımlanır ve 12 ay geçerlidir; ödeme sonrası hakkınız aynı gün hesabınıza işlenir.</p>
          </div>
